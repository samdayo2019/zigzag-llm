...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x: Tensor):
        ...
        key: Tensor = self.key_proj(x).reshape(
            self.cfg.batch_size, self.cfg.prefill_size, num_kv_tensors, self.cfg.head_size
        )
        ...
        query_grouped = query.view(
            self.cfg.batch_size, self.cfg.prefill_size, num_kv_tensors, num_head_tensors//num_kv_tensors, self.cfg.head_size
        )
